...
type ManifoldSuite struct {
	...
	ephemeralProviderFactory *MockEphemeralProviderFactory
...
func (s *ManifoldSuite) setupMocks(c *tc.C) *gomock.Controller {
	...
	s.ephemeralProviderFactory = NewMockEphemeralProviderFactory(ctrl)
...
func (s *ManifoldSuite) newGetter(overlay map[string]interface{}) dependency.Getter {
	resources := map[string]interface{}{
		...
		"provider-tracker":    s.ephemeralProviderFactory,
	}
