...
//go:generate go run go.uber.org/mock/mockgen -typed -package apiserver_test -destination provider_mock_test.go github.com/juju/juju/core/providertracker EphemeralProviderFactory,Provider
