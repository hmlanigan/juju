...
//go:generate go run go.uber.org/mock/mockgen -typed -package migration -destination services_mock_test.go github.com/juju/juju/internal/migration ProviderConfigServicesGetter,ProviderConfigServices,ModelConfigService,ControllerCloudService
