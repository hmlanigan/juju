...
func (s *websocketSuite) TestWebsocketDialWithErrorsJSON(c *gc.C) {
...
func (s *websocketSuite) TestWebsocketDialWithErrorsNoJSON(c *gc.C) {
...
func (s *websocketSuite) TestWebsocketDialWithErrorsOtherError(c *gc.C) {
	var d fakeDialer
...
func (s *websocketSuite) TestWebsocketDialWithErrorsSetsDeadline(c *gc.C) {
