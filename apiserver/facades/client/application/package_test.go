...
//go:generate go run github.com/golang/mock/mockgen -package application -destination deployrepository_mocks_test.go github.com/juju/juju/apiserver/facades/client/application DeployFromRepositoryState,DeployFromRepositoryModel
