...
// Source: github.com/juju/juju/worker/uniter/relation (interfaces: StateTrackerState,Unit,Application,Relation,RelationUnit)
...
func (m *MockStateTrackerState) Relation(arg0 names.RelationTag) (relation0.Relation, error) {
	m.ctrl.T.Helper()
...
func (m *MockStateTrackerState) RelationById(arg0 int) (relation0.Relation, error) {
	m.ctrl.T.Helper()
...
func (m *MockRelation) Unit(arg0 names.UnitTag, arg1 names.ApplicationTag) (relation0.RelationUnit, error) {
	m.ctrl.T.Helper()
...
func (mr *MockRelationMockRecorder) Unit(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
